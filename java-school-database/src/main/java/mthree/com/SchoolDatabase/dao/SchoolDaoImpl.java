...
public class SchoolDaoImpl implements SchoolDao {
    ...
    public List<TeacherCount> teacherCountByDept() {
        ...
        // Keep track of count using COUNT(*) keyword
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        // I initially assumed courses with zero students enrolled should also be
        // displayed. However, based on testing results,
        // I determined that only courses with at least one enrolled student are
        // required. Therefore, I used an inner join instead of a left join.
